# Helpful Q&A Assistant

Telegram bot providing concise, professional answers with short per-user context, simple commands (/start /help /settings), and inline feedback.
